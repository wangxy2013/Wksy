...
public class DataRequest
{
    ...
    public void request1(Context mContext, String url, IRequestListener listener, int httpType, String reqType,
                        Map<String, List> valuePairs, JsonHandler handler)
    {
        HttpRequest1 request = new HttpRequest1(mContext, httpType, reqType, url, valuePairs, listener, handler);
        ThreadPoolFactory.execute(request);
    }
