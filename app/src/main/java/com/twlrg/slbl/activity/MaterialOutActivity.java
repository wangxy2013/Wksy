 ...
 * 描述：材料扫描出库
 */
public class MaterialOutActivity extends BaseActivity implements IRequestListener
{
    ...
    private static final int          CHECK_OUT_SUCCESS = 0x06;
        ...
        public void handleMessage(Message msg)
        {
            ...
            switch (msg.what)
            {
                ...
                case REQUEST_SUCCESS:
                    ...
                    {
                        mete_id = mProductInfo.getMete_id();
                        tvMeteId.setText(mete_id);
                ...
                case REQUEST_FAIL:
                    ToastUtil.show(MaterialOutActivity.this, msg.obj.toString());
                    break;
                ...
                case CHECK_OUT_SUCCESS:
                    ToastUtil.show(MaterialOutActivity.this, "操作成功");
                    finish();
                    break;
            }
        }
    ...
    {
        setContentView(R.layout.activity_materail_out);
    }
    ...
    protected void initEvent()
    {
        ...
        etLibrary.setOnClickListener(this);
    }
    ...
    protected void initViewData()
    {
        ...
        DataRequest.instance().request(MaterialOutActivity.this, Urls.getProductDetailUrl(), this, HttpRequest.POST, GET_PRODUCT_DETAIL, valuePairs,
    ...
    private void checkOut()
    {
        ...
        if (StringUtils.stringIsEmpty(count) || count.startsWith("0"))
        {
            ToastUtil.show(this, "请输入正确的出库数量！");
            return;
        }

        Map<String, String> valuePairs = new HashMap<>();
        valuePairs.put("KW", kw_code);
        valuePairs.put("METE_ID", mete_id);
        valuePairs.put("OUT_COUNT", count);
        valuePairs.put("T_ID", t_id);
        DataRequest.instance().request(MaterialOutActivity.this, Urls.getCheckoutUrl(), this, HttpRequest.POST, CHECK_OUT, valuePairs,
                new ResultHandler());
    }
                    ...
                    DialogUtils.showKWInfoDialog(this, kwInfoList, new MyItemClickListener()
                    {
                        ...
                        public void onItemClick(View view, int position)
                        {
                            ...
                            if (null != mKWInfo)
                            {
                                ...
                                etLibrary.setText(mKWInfo.getKw_name());
                            }
                        }
                    });
                }
    ...
    public void notify(String action, String resultCode, String resultMsg, Object obj)
    {
        ...
        else if (CHECK_OUT.equals(action))
        {
            if (ConstantUtil.RESULT_SUCCESS.equals(resultCode))
            {
                mHandler.sendMessage(mHandler.obtainMessage(CHECK_OUT_SUCCESS, obj));
            }
